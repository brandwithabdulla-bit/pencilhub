...
import { Sparkles, Film, Video, Layout } from "lucide-react";
  ...
  const services = [
    {
      id: "branding",
      title: "Branding",
      desc: "Creating memorable brands through custom logo designs, robust visual systems, brand manuals, and tailored typography specimens.",
      icon: Sparkles,
      color: "text-blue-500",
    ...
    },
    {
      ...
      desc: "Synchronized keyframe transitions, logo reveal sequences, kinetic typography, and rich visual storytelling overlays.",
      icon: Film,
    ...
    },
    {
      id: "editing",
      title: "Video Editing",
      desc: "High-end content flow, cinematic audio packaging, and precise color grading panel matching for local visual narratives.",
      icon: Video,
      color: "text-rose-500",
    ...
    },
    {
      id: "uiux",
      title: "UX/UI",
      desc: "Converting visits into clicks with responsive browser mockup guides, cursor interactions, and visual layout frameworks.",
      icon: Layout,
              ...
              >
                ...
                <div className="flex flex-col gap-2 px-1">
                  <div className="flex items-center gap-3">
                    ...
                    <div className={`p-2 rounded-xl border border-card-border ${service.badgeBg} ${service.color} transition-transform duration-300 group-hover:scale-105`}>
